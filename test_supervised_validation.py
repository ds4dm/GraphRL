...
from gcn.models_gcn import GCN_Policy_SelectNode, GCN_Sparse_Policy_SelectNode, GCN_Sparse_Memory_Policy_SelectNode, GCN_Sparse_Policy_10, GCN_Sparse_Memory_Policy_SelectNode_10
...
t_plot, total_loss_val_np, val_ave_gcn_np, val_ave_mind_np = policy_sl.validation_single_epoch(epoch=0, lr=args.lr, val_dataset=val_dataset, dataset_type=dataset_type)
