        ...
        for epoch in range(n_epochs):
            ...
            plt.savefig(
                './results/rl/rmc/hyper_lractor_acmc_std_r_' + str(
                    lr_actor) + '_epsilon_' + str(self.model.epsilon.numpy()) + '_' + self.heuristic + '_curve_g2m_number_gan-10-h10-memo_logsoftmax_no_pretrain_train_' + self.train_dataset.__class__.__name__ + '_unlim_depth_prune_cuda' + str(
            ...
            plt.savefig(
                './results/rl/rmc/hyper_lractor_acmc_std_r_' + str(
                    lr_actor) + '_epsilon_' + str(self.model.epsilon.numpy())  + '_' + self.heuristic + '_curve_g2m_number_gan-10-h10-memo_logsoftmax_no_pretrain_val_' + self.train_dataset.__class__.__name__ + '_unlim_depth_prune_cuda' + str(
                    self.use_cuda) + '_return_-mean.png')
            plt.clf()
            ...
            plt.savefig(
                './results/rl/rmc/hyper_lractor_acmc_std_r_' + str(
                    lr_actor) + '_epsilon_' + str(self.model.epsilon.numpy()) + '_' + self.heuristic + '_loss_curve_g2m_number_gan-10-h10-memo_logsoftmax_no_pretrain_val_' + self.train_dataset.__class__.__name__ + '_umlim_depth_prune_cuda' + str(
                    self.use_cuda) + '_return_-mean.png')
            plt.clf()
